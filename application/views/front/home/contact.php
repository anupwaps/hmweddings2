...
?>
<section class="slice bg-base-2 no-padding" style="background-image: url(<?=base_url()?>uploads/home_page/premium_plans_image/<?=$premium_plans_image[0]['image']?>)">
    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-12 no-padding">
                                <div class="same-height bg-base-2" data-same-height="#same_height_1">
                                    <center>
                                        <div class="sct-inner px-2 py-4">
                                            <h3 class="heading heading-5 strong">
                                            <?php echo translate('contact_information ')?></h3>
                                            <!--<p class="mt-3 mb-3">
                                                <?=$home_contact_info_text?>
                                            </p>-->
                                            <div class="icon-block--style-3 mb-1 mt-2">
                                                <i class="icon ion-ios-telephone bg-base-2"></i>
                                                <span class="heading heading-6 strong-400">
                                                <?=$home_contact_phone?> </span>
                                            </div>
                                            <div class="icon-block--style-3 mb-2">
                                                <i class="icon ion-ios-email bg-base-2"></i>
                                                <span class="heading heading-6 strong-400">
                                                <?=$this->system_email?> </span>
                                            </div>
                                            <div class="icon-block--style-3">
                                                <i class="icon ion-ios-location bg-base-2"></i>
                                                <span class="heading heading-6 strong-400">
                                                <?=$home_contact_address?> </span>
                                            </div>
                                            <span class="clearfix"></span>
                                            <a href="<?=base_url()?>home/contact_us" class="btn btn-styled btn-block btn-base-1 btn-outline btn-circle mt-3 z-depth-2-bottom" style="width: 40%;color: #FFF!important">
